...
export const courseModules: Module[] = [
  {
    ...
    description:
      "Comprendre les concepts clés de la transformation digitale, la différence entre numérisation, digitalisation et transformation.",
    keyMessage:
      "La transformation digitale est avant tout une transformation stratégique, organisationnelle et humaine. La technologie n'est qu'un levier.",
    ...
    sections: [
      {
        ...
        figures: [
          {
            src: numerisationProcess,
            caption:
              "Figure 1.1 - Processus de numérisation et stockage sécurisé",
          },
        ],
      },
      {
        ...
        keyPoints: [
          ...
          "Modélisation AS-IS / TO-BE",
          "Déploiement et automatisation",
          "Formation utilisateurs",
        ],
        figures: [
          {
            src: digitalisationProcess,
            caption:
              "Figure 1.2 - Workflow de digitalisation des processus métier",
          },
          {
            src: digitalisationBenefits,
            caption:
              "Figure 1.2b - Avantages de la digitalisation : réduction des coûts, erreurs et temps",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: digitalTransformationPyramid,
            caption:
              "Figure 1.3 - Pyramide de la transformation digitale : de la numérisation à la transformation",
          },
          {
            src: transformationLevels,
            caption:
              "Figure 1.3b - Les 5 niveaux de transformation : Digitize, Organize, Automate, Streamline, Transform",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: thirteenDrivers,
            caption:
              "Figure 1.4 - Les 13 facteurs clés de la transformation digitale",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: top10Failure,
            caption:
              "Figure 1.5 - TOP 10 des raisons d'échec de la transformation digitale",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: sixPillars,
            caption:
              "Figure 1.6 - Les six piliers de la transformation digitale",
          },
          {
            src: pillarsDetails,
            caption:
              "Figure 1.6b - Digital Transformation Pillars : Strategy, People, Process, Technology",
          },
        ],
      },
    ],
    quiz: [
      {
        id: "q1-1",
        question:
          "Quelle est la différence principale entre numérisation et digitalisation ?",
        options: [
        ...
        correctAnswers: [1],
        explanation:
          "La numérisation consiste à convertir un support physique en format numérique sans modifier le processus sous-jacent, tandis que la digitalisation automatise les processus existants à l'aide d'outils numériques.",
      },
      {
        id: "q1-2",
        question:
          "Combien de piliers fondamentaux compte la transformation digitale selon le cours ?",
        options: ["4 piliers", "5 piliers", "6 piliers", "8 piliers"],
        correctAnswers: [2],
        explanation:
          "Les six piliers sont : Vision et stratégie, Gouvernance et leadership, Processus métiers, Technologies, Données, Culture et compétences.",
      },
      {
        id: "q1-3",
        question:
          "Parmi les causes d'échec des projets digitaux, lesquelles sont mentionnées ? (plusieurs réponses possibles)",
        options: [
        ...
        explanation:
          "Les principales causes d'échec incluent l'absence de vision claire, la gouvernance inefficace et la résistance au changement ignorée. Un budget important n'est pas une cause d'échec.",
      },
      {
        id: "q1-4",
        ...
        correctAnswers: [1],
        explanation:
          "Le message clé souligne que la transformation digitale est avant tout une transformation stratégique, organisationnelle et humaine. La technologie n'est qu'un levier.",
      },
      {
        id: "q1-5",
        question:
          "Combien de facteurs clés (Key Drivers) de la transformation digitale sont identifiés ?",
        options: ["10 facteurs", "12 facteurs", "13 facteurs", "15 facteurs"],
        correctAnswers: [2],
        explanation:
          "Le cours identifie 13 Key Drivers de la transformation digitale, incluant l'adoption digitale, la prise de décision, l'agilité, les nouveaux modèles d'affaires, etc.",
      },
    ],
  },
  {
    ...
    description:
      "Découvrir le rôle central de la gouvernance dans la transformation et les responsabilités du Chief Digital Transformation Officer.",
    keyMessage:
      "Sans gouvernance claire et leadership fort, aucune transformation digitale ne peut réussir, quel que soit le niveau technologique.",
    ...
    sections: [
      {
        ...
        figures: [
          {
            src: governanceStructure,
            caption: "Figure 2.1 - Structure de gouvernance IT et digitale",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: governanceSI,
            caption: "Figure 2.2 - Les dimensions de la gouvernance du SI",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: cdtoRoles,
            caption: "Figure 2.3 - Les 7 rôles du Chief Transformation Officer",
          },
        ],
      },
      {
        ...
        keyPoints: [
          ...
          "CTO = Technologie",
          "CDO = Données",
          "CDTO = Transformation globale",
        ],
        figures: [
          {
            src: top10Roles,
            caption: "Figure 2.3b - TOP 10 Digital Transformation Roles",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: cdtoMissions,
            caption: "Figure 2.4 - Les 6 missions stratégiques du CDTO",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: gartnerLeadership,
            caption:
              "Figure 2.5 - Recommandations Gartner pour le Digital Transformation Leader",
          },
        ],
      },
    ],
    quiz: [
      {
        ...
        correctAnswers: [1],
        explanation:
          "La gouvernance digitale garantit l'alignement stratégique, la cohérence des projets, la maîtrise des coûts et des risques, et la création de valeur mesurable.",
      },
      {
        id: "q2-2",
        question:
          "Combien de rôles clés du CDTO sont identifiés dans le cours ?",
        options: ["5 rôles", "6 rôles", "7 rôles", "8 rôles"],
        correctAnswers: [2],
        explanation:
          "Les 7 rôles sont : Innovator, Storyteller, Role Model, Corporate Architect, Advocate, Bookkeeper, Collaborator.",
      },
      {
        id: "q2-3",
        question:
          "Quelle est la différence principale entre le CDO et le CDTO ?",
        options: [
        ...
        correctAnswers: [1],
        explanation:
          "Le CDO (Chief Data Officer) se concentre sur la gouvernance des données, tandis que le CDTO pilote la transformation digitale globale et transverse.",
      },
      {
        id: "q2-4",
        ...
        correctAnswers: [1],
        explanation:
          "Le message clé souligne que sans gouvernance claire et leadership fort, aucune transformation digitale ne peut réussir, quel que soit le niveau technologique.",
      },
    ],
  },
  {
    ...
    description:
      "Apprendre à évaluer le niveau de maturité digitale d'une organisation et identifier les axes d'amélioration.",
    keyMessage:
      "Un diagnostic précis de l'existant est le fondement de toute stratégie de transformation réussie.",
    ...
    sections: [
      {
        ...
        figures: [
          {
            src: diagnosticIllustration,
            caption: "Figure 3.0 - Illustration du diagnostic de l'existant",
          },
        ],
      },
      {
        ...
        keyPoints: [
          "Diagnostic SI = technique",
          "Diagnostic TD = stratégique",
          "Vision globale",
          "Création de valeur",
        ],
        figures: [
          {
            src: diagnosticComparison,
            caption:
              "Figure 3.1 - Comparaison Diagnostic SI vs Diagnostic de Transformation",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        figures: [
          {
            src: diagnosticMaturity,
            caption: "Figure 3.1 - Les 5 niveaux de maturité digitale",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: painPoints,
            caption: "Figure 3.3 - Les 4 types de points de douleur client",
          },
          {
            src: painPointsTypes,
            caption:
              "Figure 3.3b - Détail des Pain Points : Financial, Productivity, Process, Support",
          },
        ],
      },
      {
        ...
        keyPoints: [
          ...
          "Matrice de maturité",
          "Synthèse exécutive",
          "Base pour la stratégie",
        ],
        figures: [
          {
            src: diagnosticLivrables,
            caption: "Figure 3.4 - Livrables du diagnostic digital",
          },
        ],
      },
    ],
    quiz: [
      {
        id: "q3-1",
        question:
          "Combien de dimensions sont analysées dans un diagnostic digital complet ?",
        options: [
          "3 dimensions",
          "4 dimensions",
          "5 dimensions",
        ...
        correctAnswers: [2],
        explanation:
          "Les 5 dimensions sont : Organisation et gouvernance, Processus métiers, Système d'information, Données, Cybersécurité.",
      },
      {
        id: "q3-2",
        ...
        correctAnswers: [2],
        explanation:
          "Les 5 niveaux sont : Initial, Réactif, Structuré, Piloté, Optimisé.",
      },
      {
        id: "q3-3",
        question:
          "Quels sont les types de pain points mentionnés ? (plusieurs réponses)",
        options: [
        ...
        correctAnswers: [0, 2, 3],
        explanation:
          "Les 4 types sont : Financial, Productivity, Process et Support Pain Points. Technical n'en fait pas partie.",
      },
      {
        id: "q3-4",
        question:
          "Quelle est la différence entre diagnostic SI et diagnostic de transformation digitale ?",
        options: [
          "Ils sont identiques",
        ...
        correctAnswers: [2],
        explanation:
          "Le diagnostic de transformation digitale englobe le diagnostic SI mais va au-delà en incluant l'organisation, les métiers, la gouvernance et la culture.",
      },
    ],
  },
  {
    ...
    description:
      "Élaborer une vision digitale et construire une feuille de route actionnable pour la transformation.",
    keyMessage:
      "Une stratégie digitale claire traduit la vision en actions concrètes et mesurables.",
    ...
    sections: [
      {
        ...
        figures: [
          {
            src: strategyDigital,
            caption: "Figure 4.1 - Les questions clés de la stratégie digitale",
          },
          {
            src: strategyQuestions,
            caption: "Figure 4.1b - Qui, Où, Quoi, Comment, Combien ?",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: visionStrategy,
            caption: "Figure 4.2 - Vision & Strategy : le point de départ",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: strategicAxes,
            caption: "Figure 4.3 - Exemple d'axes stratégiques digitaux",
          },
          {
            src: axesIcons,
            caption: "Figure 4.3b - Icônes des axes A, B, C, D, E",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: roadmapSteps,
            caption:
              "Figure 4.3 - Les étapes de construction de la feuille de route",
          },
        ],
      },
      {
        ...
        figures: [
          {
            ...
            caption: "Figure 4.5 - Matrice de priorisation Impact / Effort",
          },
          {
            src: prioritizationIcon,
            caption: "Figure 4.5b - Schéma de priorisation",
          },
        ],
      },
      {
    ...
    quiz: [
      {
        ...
        correctAnswers: [2],
        explanation:
          "Les 4 questions sont : Où voulons-nous aller ? Quelle valeur créer ? Pour quels usagers ? À quel horizon ?",
      },
      {
        id: "q4-2",
        ...
        correctAnswers: [1],
        explanation:
          "Les 3 horizons sont : Court terme (quick wins), Moyen terme (structuration), Long terme (transformation profonde).",
      },
      {
        id: "q4-3",
        question:
          "Quels critères sont utilisés pour la priorisation des initiatives ?",
        options: [
        ...
        correctAnswers: [0],
        explanation:
          "Les 4 critères sont : Valeur métier attendue, Coût, Niveau de risque, Complexité.",
      },
    ],
  },
  {
    ...
    description:
      "Comprendre les principes d'urbanisation du système d'information et élaborer un Schéma Directeur des SI.",
    keyMessage:
      "L'urbanisation du SI assure la cohérence, la flexibilité et l'évolutivité de l'écosystème technologique.",
    ...
    sections: [
      {
        ...
        keyPoints: [
          ...
          "Éviter l'hétérogénéité",
          "Agilité",
          "Alignement métier",
        ],
        figures: [
          {
            src: urbanisationPerspectives,
            caption: "Figure 5.1 - Les 4 perspectives de l'urbanisme SI",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: urbanisationPrinciples,
            caption: "Figure 5.1b - Principes fondamentaux de l'urbanisation",
          },
        ],
      },
      {
        ...
        figures: [
          { src: togafCycle, caption: "Figure 5.2 - Le cycle ADM de TOGAF" },
          {
            src: togafAdm,
            caption:
              "Figure 5.2b - Détail des phases ADM : A, B, C, D, E, F, G, H",
          },
        ],
      },
      {
        ...
        figures: [
          {
            ...
            caption: "Figure 5.3 - Les couches de l'architecture technique",
          },
          {
            src: businessLayer,
            caption: "Figure 5.3b - La couche métier et fonctionnelle",
          },
          {
            src: functionalDiagram,
            caption: "Figure 5.3c - Diagramme fonctionnel Input/Process/Output",
          },
          {
            src: applicationLayer,
            caption: "Figure 5.3d - La couche applicative",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: asIsToBeSchema,
            caption: "Figure 5.4 - Cartographies AS-IS et TO-BE",
          },
        ],
      },
      {
        ...
        keyPoints: [
          ...
          "Data comme carburant",
        ],
        figures: [
          {
            src: sdsiSchema,
            caption: "Figure 5.4 - Structure du Schéma Directeur des SI",
          },
        ],
      },
    ],
    quiz: [
      {
        id: "q5-1",
        question:
          "Quels sont les 4 principes fondamentaux de l'urbanisation du SI ?",
        options: [
        ...
        correctAnswers: [1],
        explanation:
          "Les 4 principes sont : Alignement métier, Modularité, Interopérabilité, Évolutivité.",
      },
      {
        id: "q5-2",
        ...
        correctAnswers: [1],
        explanation:
          "AS-IS représente l'état actuel du SI (photographie de l'existant) et TO-BE représente l'état cible après transformation.",
      },
      {
        id: "q5-3",
        ...
        correctAnswers: [1],
        explanation:
          "Le SDSI formalise typiquement la trajectoire d'évolution du SI sur un horizon de 3 à 5 ans.",
      },
    ],
  },
  {
    ...
    description:
      "Explorer les technologies clés de la transformation : data analytics, cloud computing, IA et autres innovations.",
    keyMessage:
      "Les données sont le nouveau pétrole et le cloud est l'infrastructure de l'agilité digitale.",
        ...
        figures: [
          {
            src: dataIntegration,
            caption:
              "Figure 6.1 - Processus d'intégration et qualité des données",
          },
        ],
      },
      {
        ...
        figures: [
          {
            src: infrastructureDiagram,
            caption: "Figure 6.2 - Diagramme d'infrastructure IT et Cloud",
          },
        ],
      },
      {
    ...
    quiz: [
      {
        ...
        correctAnswers: [1],
        explanation:
          "Les 3 types de services cloud sont : IaaS (Infrastructure), PaaS (Platform), SaaS (Software) as a Service.",
      },
      {
        id: "q6-2",
        ...
        correctAnswers: [1],
        explanation:
          "RPA signifie Robotic Process Automation - l'automatisation des tâches répétitives par des robots logiciels.",
      },
      {
        id: "q6-3",
        ...
        correctAnswers: [1],
        explanation:
          "Les 4 niveaux sont : Descriptif (que s'est-il passé), Diagnostique (pourquoi), Prédictif (que va-t-il se passer), Prescriptif (que faire).",
      },
    ],
  },
  {
    ...
    shortTitle: "Pilotage",
    description:
      "Maîtriser les méthodes et outils de pilotage des grands programmes de transformation digitale.",
    keyMessage:
      "Un pilotage rigoureux et agile est la clé du succès des programmes de transformation.",
    ...
    quiz: [
      {
        id: "q7-1",
        question:
          "Quel est le rôle du Sponsor dans un programme de transformation ?",
        options: [
        ...
        correctAnswers: [1],
        explanation:
          "Le Sponsor porte la vision de la transformation et dispose de l'autorité pour débloquer les obstacles rencontrés.",
      },
      {
        id: "q7-2",
        ...
        correctAnswers: [1],
        explanation:
          "PPM signifie Project Portfolio Management - la gestion du portefeuille de projets.",
      },
    ],
  },
  {
    ...
    description:
      "Intégrer la sécurité et la conformité dans la stratégie de transformation digitale.",
    keyMessage:
      "La cybersécurité doit être intégrée dès la conception (Security by Design) et non en fin de projet.",
    ...
    quiz: [
      {
        ...
        correctAnswers: [1],
        explanation:
          "Security by Design signifie intégrer la sécurité dès la conception des projets, et non en fin de développement.",
      },
      {
        id: "q8-2",
        question:
          "Quelles sont les 5 fonctions du NIST Cybersecurity Framework ?",
        options: [
        ...
        correctAnswers: [1],
        explanation:
          "Les 5 fonctions NIST sont : Identify, Protect, Detect, Respond, Recover.",
      },
      {
        id: "q8-3",
        ...
        correctAnswers: [1],
        explanation:
          "PCA = Plan de Continuité d'Activité (maintenir les activités critiques), PRA = Plan de Reprise d'Activité (redémarrer après un sinistre).",
      },
    ],
  },
  {
    ...
    description:
      "Accompagner les équipes dans l'adoption des nouveaux outils et pratiques digitales.",
    keyMessage:
      "La technologie ne transforme rien sans l'adhésion et l'engagement des collaborateurs.",
    ...
    quiz: [
      {
        ...
        correctAnswers: [2],
        explanation:
          "Le modèle de Kotter comprend 8 étapes pour conduire le changement avec succès.",
      },
      {
        id: "q9-2",
        ...
        correctAnswers: [1],
        explanation:
          "ADKAR signifie : Awareness (conscience), Desire (désir), Knowledge (connaissance), Ability (capacité), Reinforcement (renforcement).",
      },
      {
        id: "q9-3",
        ...
        correctAnswers: [1],
        explanation:
          "Les Champions du digital sont des utilisateurs avancés qui aident leurs collègues, servent de relais terrain et sont des modèles positifs d'adoption.",
      },
    ],
  },
  {
    ...
    description:
      "Se préparer efficacement à l'examen de certification Certified Digital Transformation Officer.",
    keyMessage:
      "L'étude de cas est déterminante : elle reflète la posture réelle du CDTO.",
    ...
    quiz: [
      {
        id: "q10-1",
        question:
          "Quelle est la pondération de l'étude de cas dans la certification ?",
        options: ["30%", "40%", "50%", "60%"],
        correctAnswers: [2],
        explanation:
          "L'étude de cas représente 50% de la note finale, ce qui en fait l'épreuve la plus importante.",
      },
      {
        id: "q10-2",
        question:
          "Quelle note minimale faut-il obtenir pour valider la certification ?",
        options: ["60/100", "65/100", "70/100", "75/100"],
        correctAnswers: [2],
        explanation:
          "La note minimale globale requise est de 70/100 pour obtenir la certification CDTO.",
      },
      {
        id: "q10-3",
        ...
        correctAnswers: [2],
        explanation:
          "Les 6 livrables sont : diagnostic, vision/axes, feuille de route, gouvernance, gestion des risques, conduite du changement.",
      },
      {
        id: "q10-4",
        ...
        correctAnswers: [1],
        explanation:
          "Il faut obtenir au moins 60% à l'étude de cas pour valider la certification, même si la note globale est supérieure à 70%.",
      },
    ],
  },
];
...
export const courseInfo = {
  title:
    "Formation à la certification Digital Transformation Chief Officer (CDTO)",
  subtitle: "Solutions Digitales & Formations",
  instructor: "DECIDE AND BUILD",
  ...
  prerequis:
    "Compréhension fondamentale des concepts des technologies de l'information et connaissance générale de la transformation numérique",
  examInfo: {
    qcmWeight: 30,
    qcmQuestions: "40-60",
